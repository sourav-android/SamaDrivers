...
public class NewOrderAdapter extends RecyclerView.Adapter<NewOrderAdapter.ViewHolder> {
    ...
    public NewOrderAdapter(Activity activity, ArrayList<HashMap<String, String>> map_list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.new_order_item, parent, false);
...
//            holder.paybale_mode.setText(activity.getString(R.string.wallet_breaket));
        ...
        if (map.get(STATUS).equals("N")) {
            ...
            //holder.trackorder.setVisibility(View.VISIBLE);
            holder.grabOrder.setBackgroundColor(activity.getResources().getColor(R.color.orange_clr));
            ...
            //holder.trackorder.setVisibility(View.GONE);
            holder.grabOrder.setBackgroundColor(activity.getResources().getColor(R.color.green_txt_clr));
            holder.status.setTextColor(activity.getResources().getColor(R.color.green_txt_clr));
        }
...
//                holder.reschedule_date.setText(activity.getString(R.string.reschedule_on));
//                holder.reschedule_date2.setText(android.text.format.DateFormat.format("dd, MMM yyyy HH:mm:ss", date2));
        ...
        holder.grabOrder.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                LottieAlertDialog alertDialog = new LottieAlertDialog.Builder(activity, DialogTypes.TYPE_QUESTION)
                        .setTitle("Grab Order")
                        .setDescription("Do you want to grab order?")
...
//                openWhatsAppConversation(activity,phone_no,"*عزيزي العميل* أنا مندوب شركة *_سما للعدسات اللاصقة_* , أرغب في توصيل شحنتك إليك اليوم. يرجى التكرم بإرسال موقعك ليتم توصيل الشحنة بأسرع وقت أتمنى لك يوماً سعيداً . ………………………………...... *Dear Customer,* I am a courier from *_Same Contact Lenses_* , I will deliver your order to your address Today. Could you please share your location to reach you faster. Have a nice day!");
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        private TextView order_no, invoice_no, order_date, reschedule_date, reschedule_date2,total_price, paybale_mode, item_count, status, shipping_price_tv;
        private MaterialCardView item;
        private Button grabOrder, callUser, callWhatsapp;
...
//            reschedule_date2 = itemView.findViewById(R.id.rescdle_date2);
            total_price = itemView.findViewById(R.id.total_price);
            paybale_mode = itemView.findViewById(R.id.paybale_mode);
            item_count = itemView.findViewById(R.id.item_count);
            status = itemView.findViewById(R.id.status);
            grabOrder = itemView.findViewById(R.id.grabOrder);
    ...
    public void grabOrder(String order_id,int position) {
        ...
        String server_url = "";
//        server_url = activity.getString(R.string.SERVER_URL) + "grab-order";
        server_url = activity.getString(R.string.SERVER_BASE_URL) + "grab-order";
